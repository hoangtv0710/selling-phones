    ...
    <div class="row">
        ...
        <div class="agileinfo-ads-display col-lg-9">
            <div class="wrapper">
                            ...
                            <div class="col-md-4 product-men mt-5">
                                <div class="men-pro-item simpleCart_shelfItem">
                                    <div class="men-thumb-item text-center">
                                        <img src="images/products/{{ $item->image }}" class="img-fluid w-75">
                                    ...
                                    <div class="item-info-product text-center border-top mt-4">
                                        ...
                                        <div class="info-product-price my-2">
                                            <span class="item_price">{{ number_format($item->price) }} VNĐ</span><br>
                                            @if($item->promotional > 0)
                                                <del>{{ number_format($item->promotional) }} VNĐ</del>
                                            @endif
                                        </div>
                                        <div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
                                            <a href="{{ route('add_cart', $item->id) }}" class="btn">Thêm vào giỏ hàng</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <!-- second section -->
                <div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
                    <h3 class="heading-tittle text-center font-italic">Sản phẩm giảm giá</h3>
                    <div class="row">
                        @foreach($promotional_product as $item)
                            <div class="col-md-4 product-men mt-5">
                                <div class="men-pro-item simpleCart_shelfItem">
                                    <div class="men-thumb-item text-center">
                                        <img src="images/products/{{ $item->image }}" class="img-fluid w-75">
